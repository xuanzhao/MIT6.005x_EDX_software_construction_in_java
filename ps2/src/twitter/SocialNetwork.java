...
public class SocialNetwork {
    ...
    public static List<String> influencers(Map<String, Set<String>> followsGraph) {
        Map<String, Integer> influencersCounter = new HashMap<>();

        followsGraph.values().forEach(strings -> {
            strings.forEach(s -> {
                Integer currentMentions = influencersCounter.getOrDefault(s, 0);
                influencersCounter.put(s, currentMentions + 1);
            });
        });


        List<Map.Entry<String, Integer>> orderedList = new ArrayList<>(influencersCounter.entrySet());
        orderedList.sort(((o1, o2) -> o2.getValue() - o1.getValue()));
